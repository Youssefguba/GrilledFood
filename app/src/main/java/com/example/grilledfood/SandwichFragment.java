...
public class SandwichFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        category = database.getReference("SandwichCategory");
        arabicCategory = database.getReference("SandwichCategoryArabic");
...
//                });
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent foodIntent = new Intent(getActivity(), SandwichDetails.class);
                        //CategoryId is a key, so we need to get the Key of item ..
                        foodIntent.putExtra("SandwichId", adapter.getRef(position).getKey());
