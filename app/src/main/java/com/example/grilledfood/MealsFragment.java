...
public class MealsFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        category = database.getReference("MealsCategory");
        arabicCategory = database.getReference("MealsCategoryArabic");
...
//                });
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent foodIntent = new Intent(getActivity(), MealsDetails.class);
                        //CategoryId is a key, so we need to get the Key of item ..
                        foodIntent.putExtra("MealsId", adapter.getRef(position).getKey());
